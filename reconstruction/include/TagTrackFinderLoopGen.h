...
#ifndef TagTrackFinderLoopGen_h
#define TagTrackFinderLoopGen_h
...
class TagTrackFinderLoopGen {

  public:

    TagTrackFinderLoopGen(std::string nam, std::vector<std::shared_ptr<TrkClusterFinder>>& cls, size_t iofs=0);
  ...
  private:
    ...
    std::vector<std::vector<size_t>> MakeNestedIndices(std::vector<size_t> n);
